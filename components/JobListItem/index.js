        ...
        <>
            <Card hoverable className='m-2'>
                ...
                <div className='flex justify-between'>
                    ...
                    <Button htmlType="submit" value={id} className="bg-[#512DA8] text-white hover:bg-black h-10 font-bold" onClick={showModal}>
                        Apply Now
                    </Button>
                </div>
                <Modal open={isModalOpen} onOk={handleOk} onCancel={handleCancel} footer={null} width={1000}>
                    <h1 className="font-bold text-2xl text-center my-4">Task Available</h1>
