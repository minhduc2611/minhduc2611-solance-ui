  ...
  return (
    <>
      <Card hoverable className="m-2">
        ...
        <Descriptions className="flex justify-between">
          <Descriptions.Item>{descriptions}</Descriptions.Item>
        </Descriptions>
        <div className="flex justify-between">
          <Descriptions title="Budget">
            <Descriptions.Item>1000 </Descriptions.Item>
          </Descriptions>
        ...
        <div className="flex justify-between">
          ...
          <Descriptions title="Stacks">
            <Descriptions.Item>ReactJS, NextJs, Web3</Descriptions.Item>
          </Descriptions>
        </div>
        <div className="flex justify-between">
          <p className="font-semibold text-base">Owner: Jack</p>
          <Button
            htmlType="submit"
            value={id}
